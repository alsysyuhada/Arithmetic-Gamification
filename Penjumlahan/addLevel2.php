...
<body>
	...
	<iframe src="../dialog/success-add2.html" id="success-add2" style="display: none;"></iframe>
		...
		<script src="soalLevel2.js"></script>
</body>
	<iframe title="popupjeda" style="visibility: hidden;" id="popupJeda" src="../popupjeda.php"></iframe>
	<iframe title="petunjuk" style="display: none;" id="petunjuk" src="../petunjuk/petunjukAddLevel2.html"></iframe>
</html>