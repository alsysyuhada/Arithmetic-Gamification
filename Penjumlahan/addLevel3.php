...
<body>
	...
	<iframe src="../dialog/success-add3.html" id="success-add3" style="display: none;"></iframe>
</body>
	<iframe style="visibility: hidden;" id="popupJeda" src="../popupjeda.php"></iframe>
	<iframe title="petunjuk" style="display: none;" id="petunjuk" src="../petunjuk/petunjukAddLevel3.html"></iframe>
	<script src="soalLevel3.js"></script>
</html>