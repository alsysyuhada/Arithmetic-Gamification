...
<body>
	...
	<iframe src="../dialog/success-add1.html" id="success-mult1" style="display: none;"></iframe>
</body>
<iframe style="visibility: hidden;" id="popupJeda" src="../popupjeda.php"></iframe>
	<iframe class="petunjuk-div-1" title="petunjuk" style="display: none;" id="petunjuk" src="../petunjuk/petunjukAddLevel2.html"></iframe>
<script src="multiLevel1.js"></script>
</html>