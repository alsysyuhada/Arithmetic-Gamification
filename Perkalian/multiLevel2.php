...
<body>
	...
	<iframe src="../dialog/success-add2.html" id="success-mult2" style="display: none;"></iframe>

</body>
<iframe style="visibility: hidden;" id="popupJeda" src="../popupjeda.php"></iframe>
	<iframe class="petunjuk-multi-2" title="petunjuk" style="display: none;" id="petunjuk" src="../petunjuk/petunjukAddLevel3.html"></iframe>
	<script src="multiLevel2.js"></script>
</html>